...
class Adafruit_Trellis(object):
    ...
    def begin(self, addr=0x70, bus=-1):
        ...
        self._i2c = Adafruit_I2C(addr, bus)
        self._i2c.writeList(0x21, [0])  # Turn on the oscillator.
        self.blinkRate(HT16K33_BLINK_OFF)
        self.setBrightness(15)  # Max brightness.
        self._i2c.writeList(0xA1, [0])  # Turn on interrupt, active high.
    ...
    def blinkRate(self, b):
        ...
        b = 0 if b < 0 else b
        self._i2c.writeList(HT16K33_BLINK_CMD | HT16K33_BLINK_DISPLAYON | (b << 1), [0])
